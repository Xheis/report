...
It is possible for categories to be mutually-exclusive, such as that of the an animal's genus, or it could be non-unique, such as a song's genre. 
...
%
\section{Background}
\subsection{Machine Learning from a Mechatronics Perspective}
...
\paragraph{Modern application of Machine Learning}
Traditional approaches are to fit a function to a 
...
\subsection{Summary of Problem Analysis: Final Problem Analysis and Discussion}
% \subsection{Discussion}
The purpose of the project is to hypothesis and produce a proof-of-concept machine learning solution to improve debriefing processes and outcomes. This should also provide an excellent learning opportunity for the author. \flagforreview
...
A package of future work would be to analyse whether the method of preprocessing chosen affects the results. For example, this project used MFFCs, but another common practice is to use a sliding window spectrograms.
...
\bibliography{main} 
\bibliographystyle{harvard} \flagforreview %IEEE
...
\clearpage \section{Trade-Review of "Online vs Offline" processing}\label{sec:TradeReview}
