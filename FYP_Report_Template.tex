...
The ExtraSensory dataset contains 60 Users (in a format CSV with 278 feature columns), as shown in \ref{tab:ExtraSensoryDataExample}. The dataset is unbalanced, and contains multiple labels. Further details about the users themselves can be found in \ref{tab:ExtraSensoryDataBreakdown}.
